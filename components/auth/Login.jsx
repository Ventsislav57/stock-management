...
const Login = () => {
  ...
  return (
    <section className="login relative">
      <div className="fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-[400px] h-[500px] rounded-xl bg-white/10 backdrop-blur-xs border-2 border-white/50">
        <form
          onSubmit={loginHandler}
          className="h-full flex flex-col justify-between py-10 px-5"
        >
          <div>
            <h1 className="text-white text-3xl tracking-wider text-center pt-6 relative z-10 border-b-2 border-white pb-3 w-2/3 mx-auto">
              Добре дошъл!
            </h1>
            ...
            <div className="flex flex-col gap-1 mt-5 relative">
              ...
              <input
                ...
                onChange={changeHandler}
              />
              {/* Тук можеш да активираш toggle password видимост, ако искаш */}
            </div>
          </div>
